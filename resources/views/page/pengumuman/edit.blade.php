          ...
          <div class="card-body">
            ...
            <form action="/pengumuman/{{$pengumuman->id}}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group input-group-static my-3">
                  ...
                  <input type="text" class="form-control" name="judul" id="judul" autocomplete="off" value="{{$pengumuman->judul}}">
                </div>
                <div class="input-group input-group-static my-3">
                    <label for="isi" class="ms-0">Isi</label>
                    <textarea class="form-control" name="isi" rows="3" style="resize:none" autocomplete="off" id="isi">{{$pengumuman->isi}}</textarea>
                </div>
